...
回顾 [创建 API 令牌](/code80/register/4-token)，在 Code80 中创建对应分组的令牌，点击复制按钮，复制 API Key 到剪切板：
...
![AionUi LLM 配置界面](/images/code80/Advanced/AionUI/Setting_LLM.webp)

2. 选择平台 "自定义"

![AionUi 选择自定义平台](/images/code80/Advanced/AionUI/customizellm1.webp)

3. 根据下方各模型配置，填入对应的 API Key 和配置信息、选择模型

![AionUi 填入配置信息](/images/code80/Advanced/AionUI/inputinfo2.webp)

4. 保存后返回主界面，选择配置的模型开始使用

![AionUi 选择模型开始使用](/images/code80/Advanced/AionUI/newchat.webp)
...
* **API Key** ：粘贴从 Code80 复制的 API Key
* **API 请求地址** ：`https://code.ai80.vip`
* **模型** ：选择 Code80 支持的 Gemini 模型
