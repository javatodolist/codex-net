...
本教程用于将 **DeepSeek** 分组接入 **Claude Code** 使用。开始前请先确认本地已经完成 Claude Code 安装；如果还没有安装，可以先参考 [Claude Code配置](/code80/cli/2-claude) 中的安装与基础配置步骤。
...
![步骤截图](/images/code80/Advanced/DeepSeekClaudeCode/01.webp)
...
![步骤截图](/images/code80/Advanced/DeepSeekClaudeCode/02.webp)
...
![步骤截图](/images/code80/Advanced/DeepSeekClaudeCode/03.webp)
